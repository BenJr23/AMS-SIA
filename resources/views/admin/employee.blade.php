            ...
            <div class="p-4 text-center text-gray-500">
                ...
                <div class="p-6">
                    ...
                    <div class="mb-4 flex justify-start">
                        <button onclick="openModal('NewModal')" class="bg-green-500 text-white px-4 py-2 rounded-lg shadow hover:bg-green-600">
                            New Member
                        </button>
                    </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select class="w-full mt-1 px-3 py-2 border rounded bg-gray-100 text-gray-800" id="employeeType" required>
                                    ...
                                    <option value="maintenance">Library Admin</option>
                                </select>
        ...
        <div id="DeleteModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 items-center justify-center hidden">
            <div class="bg-white p-6 rounded-lg shadow-md w-[60%] max-w-sm">
                ...
                <div class="flex justify-end">
                    ...
                    <button type="submit" class="flex items-center px-4 py-2 bg-red-500 text-white rounded hover:bg-[#011B33]">
